...
import { TransactionTypeOrmConfigService, ExpensesTypeOrmConfigService, EmployeeTypeOrmConfigService } from "./shared/typeorm/typeorm.service";
...
@Module({
  ...
  providers: [TransactionTypeOrmConfigService, ExpensesTypeOrmConfigService, EmployeeTypeOrmConfigService],
})
export class ApiModule implements NestModule {
  configure(consumer: MiddlewareConsumer) {
    consumer
      .apply(ReportLogger.use.bind(ReportLogger))
      .forRoutes('report');
  }
}